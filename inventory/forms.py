...
class ProductForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['name', 'code', 'category', 'price', 'cost_price', 'stock_quantity', 'unit', 'packaging', 'description']
        widgets = {
            ...
            'packaging': forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'Packaging (e.g. Box, Piece)'}),
